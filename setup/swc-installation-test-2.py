...
class DependencyError (Exception):
    ...
    _setup_urls = {  # (system, version, package) glob pairs
        ('*', '*', 'Cython'): 'https://docs.cython.org/src/quickstart/install.html',
        ...
        ('Linux', '*', 'chromium'): 'https://code.google.com/p/chromium/wiki/LinuxBuildInstructions',
        ('Darwin', '*', 'chromium'): 'https://code.google.com/p/chromium/wiki/MacBuildInstructions',
        ('Windows', '*', 'chromium'): 'https://www.chromium.org/developers/how-tos/build-instructions-windows',
        ...
        ('*', '*', 'networkx'): 'https://networkx.github.io/documentation/latest/install.html#installing',
        ...
        ('*', '*', 'py.test'): 'https://pytest.org/latest/getting-started.html',
